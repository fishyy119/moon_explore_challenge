...
import moon_explore.hybrid_a_star.reeds_shepp_path_planning as rs
...
class HybridAStarPlanner:
    ...
    def planning(self, start, goal, ox, oy, xy_resolution, yaw_resolution):
        """
        start: start node
        goal: goal node
        ox: x position list of Obstacles [m]
    ...
    def check_car_collision(x_list, y_list, yaw_list, ox, oy, kd_tree: cKDTree):
...
def main():
    ...
    path = planner.planning(start, goal, ox, oy, XY_GRID_RESOLUTION, YAW_GRID_RESOLUTION)
